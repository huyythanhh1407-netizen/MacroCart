...
#       not find it on your PATH.
#
#   (2) Gradle will search for your bootstrap jars in the repository only when
#       using the default wrapper task: 'gradle wrapper'. See
#       https://docs.gradle.org/current/userguide/gradle_wrapper.html
#       for more details.
#
#   (3) A horizontal line ("===========") will appear with the version of Gradle.
#
##############################################################################
...
# Collect all arguments for the java command, following the shell convention
